...
- 21f4cc8: Stamp the output trace with the per-instance block label so two Clonotype Distribution blocks on the same dataset stay distinguishable downstream.
