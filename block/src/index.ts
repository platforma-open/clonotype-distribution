...
export type SpatiotemporalAnalysisBlockContract = BlockContract;
export type SpatiotemporalAnalysisBlockOutputs  = BlockOutputs;
export type SpatiotemporalAnalysisBlockData     = BlockData;
export const SpatiotemporalAnalysisBlockPointer = BlockPointer;
