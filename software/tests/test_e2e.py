"""End-to-end tests for compartment_analysis.py CLI.

Each test invokes the script via subprocess with different arguments and
verifies the output CSV files. Synthetic CSV input data is generated per test.
